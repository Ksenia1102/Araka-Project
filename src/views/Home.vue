        ...
        <div id="home" class="landing-wrapper overflow-hidden" style="height: 100vh">
            <div class="py-6 px-6 mx-0 md:mx-12 lg:mx-20 lg:px-20 flex items-center justify-between relative lg:static">
                <a class="flex items-center" href="#">
                    <img style="height: 2rem; margin-right: 0.5rem;" src="/logo.svg" alt="" />
                    ...
                    <ul class="list-none p-0 m-0 flex lg:items-center select-none flex-col lg:flex-row cursor-pointer gap-8">
                        ...
                        <li>
                            <a @click="downloadFile" class="px-0 py-4 text-surface-900 dark:text-surface-0 font-medium text-xl">
                                <span>Получить карточки для тестов</span>
                            </a>
                        </li>
                    </ul>
            ...
            <div id="hero" class="flex flex-row pt-6 px-6 lg:px-20 overflow-hidden" style="background: linear-gradient(134.789deg, #f6fcff 1%, #c2e7ff 49%, #83b2ff 100%); clip-path: ellipse(150% 87% at 93% 13%); justify-content: space-around">
                <div class="mx-6 md:mx-20 mt-0 md:mt-6">
                    ...
                    <p class="font-normal text-2xl leading-normal md:mt-4 text-gray-700">Eduvision — удобный инструмент для учителей, позволяющий быстро создавать тесты</p>
